# Generated by Django 5.0.6 on 2025-03-10 09:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='testapp.pembimbingakademik')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nama', models.CharField(max_length=255)),
                ('email', models.EmailField(max_length=254, unique=True, validators=[testapp.validators.validate_email_penyelia])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jumlah_semester', models.IntegerField(validators=[testapp.validators.validate_jumlah_semester_mbkm])),
                ('sks_diambil', models.IntegerField(blank=True, null=True, validators=[testapp.validators.validate_sks_diambil])),
                ...
                ('pernyataan_komitmen', models.BooleanField(default=False, validators=[testapp.validators.validate_pernyataan_komitmen])),
                ...
                ('mahasiswa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testapp.mahasiswa')),
                ('penyelia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='testapp.penyelia')),
                ('program_mbkm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='testapp.programmbkm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jumlah_semester', models.IntegerField(validators=[testapp.validators.validate_jumlah_semester_kp])),
                ('sks_lulus', models.IntegerField(validators=[testapp.validators.validate_sks_lulus])),
                ('role', models.CharField(blank=True, max_length=255, null=True)),
                ('total_jam_kerja', models.IntegerField(blank=True, null=True, validators=[testapp.validators.validate_total_jam_kerja])),
                ('tanggal_mulai', models.DateField(blank=True, null=True)),
                ('tanggal_selesai', models.DateField(blank=True, null=True)),
                ('pernyataan_komitmen', models.BooleanField(default=False, validators=[testapp.validators.validate_pernyataan_komitmen])),
