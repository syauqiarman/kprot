...
from database.models import PendaftaranKP, Mahasiswa, PendaftaranMBKM
import json
...
class PendaftaranMBKMService:
    ...
    def check_has_pending_registration(user):
        ...
        try:
            ...
            PendaftaranMBKM.objects.get(
                mahasiswa=mahasiswa,
                status_pendaftaran="Menunggu Detil"
            )
            return True
        except (Mahasiswa.DoesNotExist, PendaftaranMBKM.DoesNotExist):
            return False
